...
public class CommissionReportDTO implements Serializable {
    ...
    private Long elasticSearchCommReportId;
    ...
    public Long getElasticSearchCommReportId() {
        return elasticSearchCommReportId;
    }

    public void setElasticSearchCommReportId(Long elasticSearchCommReportId) {
        this.elasticSearchCommReportId = elasticSearchCommReportId;
    }
    ...
    public String toString() {
        return "CommissionReportDTO{" +
            ...
            ", elasticSearchCommReportId=" + getElasticSearchCommReportId() +
