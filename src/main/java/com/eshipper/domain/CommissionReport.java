...
public class CommissionReport implements Serializable {
    ...
    public ElasticSearchCommReport getElasticSearchCommReport() {
        return elasticSearchCommReport;
    }

    public CommissionReport elasticSearchCommReport(ElasticSearchCommReport elasticSearchCommReport) {
        this.elasticSearchCommReport = elasticSearchCommReport;
        return this;
    }

    public void setElasticSearchCommReport(ElasticSearchCommReport elasticSearchCommReport) {
        this.elasticSearchCommReport = elasticSearchCommReport;
    }
