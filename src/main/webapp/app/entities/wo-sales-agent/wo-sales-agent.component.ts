...
export class WoSalesAgentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.woSalesAgentService
      ...
      .subscribe(
        (res: HttpResponse<IWoSalesAgent[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IWoSalesAgent[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
