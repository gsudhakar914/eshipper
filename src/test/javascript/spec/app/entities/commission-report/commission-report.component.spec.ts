...
import { CommissionReportComponent } from 'app/entities/commission-report/commission-report.component';
...
describe('Component Tests', () => {
  describe('CommissionReport Management Component', () => {
    let comp: CommissionReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommissionReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.commissionReports && comp.commissionReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
